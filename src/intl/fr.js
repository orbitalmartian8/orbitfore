export default {
  ...
  homeDescription: `
    <p>
      Orbitfore est un client web pour
  ...
  // About page
  about: 'Infos',
  aboutApp: 'Infos sur Orbitfore',
  aboutAppDescription: `
  <p>
    Orbitfore est un logiciel
    <a rel="noopener" target="_blank"
  ...
  <p>
    Orbitfore ne garde pas d'informations personelles dans ses serveurs,
    y compris les noms, addresses courriel, addresses IP, messages, et photos.
  </p>

  <p>
    Orbitfore est un site statique. Tous données sont gardées en locale dans le navigateur, et sont partagée qu'avec
  ...
  // Add instance page
  storageError: `Il semble que Orbitfore ne peut pas stocker les données en locale. Est-ce que votre navigateur
          est en mode privé, ou est-ce qu'il bloque les cookies? Orbitfore garde tous ses données en locale et
  ...
  logInToAnInstancePost: 'pour utiliser Orbitfore.',
